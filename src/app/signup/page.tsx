      ...
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          <Link href="/" className="inline-flex items-center gap-2">
            ...
            <h1 className="text-3xl font-bold tracking-tight text-text-primary">Criar Conta</h1>
          </Link>
          <p className="mt-4 text-text-secondary">Comece a usar o Entrada Facilitada hoje mesmo.</p>
        </div>
